...
export class PlayersService {
  players: Player[] = [
    ...
    },
    {
      ...
      anillos: false,
      descripcion:
        "Rodolfo 'Rudy' Fernández Farrés (Palma de Mallorca; 4 de abril de 1985) es un baloncestista español que pertenece a la plantilla del Real Madrid de la Liga ACB. Con 1,96 metros de estatura, juega indistintamente como escolta o alero. Es internacional absoluto con España desde 2004, y con la selección se ha proclamado, entre otros éxitos, bicampeón mundial en 2006 y 2019, tetracampeón continental en 2009, 2011, 2015 y 2022, doble subcampeón olímpico en Pekín 2008 y Londres 2012, y bronce en Río 2016.",
